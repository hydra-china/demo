...
class AdminCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('Tài khoản', '');
    }
    ...
    {
        CRUD::addColumn(['name' => 'name', 'type' => 'text', 'label' => 'Họ và tên']);
        CRUD::column('role')->type('text')->label('vai trò');
        /**
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('role')->type('hidden')->value('admin');
        CRUD::field('name')->type('text')->label('Họ và tên');
        CRUD::field('email')->type('email')->label('Email');
//        CRUD::field('')->type('email')->label('Email');
