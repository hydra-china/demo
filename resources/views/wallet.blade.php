...
@section('content')
    ...
    <div class="my-1 px-3 p-2 ">
        <div class="d-flex justify-content-between bg-light p-2 rounded">
            ...
            <span class="text-mb font-semi-bold">{{number_format($wallet['amount'])}} VND</span>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Rút tiền thất bại</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>Sai thông tin liên kết ví</div>
                </div>
