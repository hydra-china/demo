...
@section('content')
    ...
    @if($hasProfile)
        <div class="text-mb text-center fw-bolder h3 text-uppercase mb-0">{{$profile['name']}}</div>
    @endif
    <div class="text-center text-secondary h5">{{ backpack_user()->{'username'} }}</div>

   @if($hasProfile)
       <div class="p-2">
           <a class="d-flex justify-content-between align-items-center btn bg-mb text-white p-2 font-semi-bold mb-2" href="{{url('/user-contract/profile')}}">
           ...
           <a class="d-flex justify-content-between align-items-center btn bg-mb text-white p-2 font-semi-bold mb-2" href="{{url('/user-detail')}}">
           ...
           <a class="d-flex justify-content-between align-items-center btn bg-mb text-white p-2 font-semi-bold" href="{{url('/contact')}}">
   ...
   @else
       <div class="text-dark text-center">
           <div class="mb-3">Bạn chưa cập nhật thông tin cá nhân và định danh</div>
           <a class="btn btn-primary" href="{{url('/verify')}}">Cập nhật ngay</a>
       </div>
   @endif
